...
func TestDay23Part2(t *testing.T) {
	...
	largestSet := d23.Part2(input)

	expectedLargestSet := "co,de,ka,ta"

	if largestSet != expectedLargestSet {
		t.Errorf("Day 23 - Part 2 (largest set) Test:\nwant %v\ngot %v\n", expectedLargestSet, largestSet)
	}
}
